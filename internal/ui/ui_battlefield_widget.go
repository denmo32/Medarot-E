...
func NewBattlefieldWidget(config *UIConfig) *BattlefieldWidget {
	whiteImg := ebiten.NewImage(1, 1)
	whiteImg.Fill(color.White)

	bgImage := ebiten.NewImageFromImage(game.R.LoadImage(game.ImageBattleBackground).Data)
...
func NewCustomIconWidget(vm *IconViewModel, config *game.Config) *CustomIconWidget {
...
func (w *CustomIconWidget) drawStateIndicator(screen *ebiten.Image, centerX, centerY float32) {
	...
	case game.StateReady:
		...
		// }
	case game.StateCharging, game.StateCooldown:
