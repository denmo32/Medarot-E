...
func InitResources(audioContext *audio.Context) {
	...
	rawResources := map[resource.RawID]resource.RawInfo{
		RawMedalsCSV:    {Path: "assets/data/medals.csv"},
		RawPartsCSV:     {Path: "assets/data/parts.csv"},
		RawMedarotsCSV:  {Path: "assets/data/medarots.csv"},
		RawFormulasJSON: {Path: "assets/data/formulas.json"},
	}
