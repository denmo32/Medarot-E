...
func NewBattleAnimationManager(config *game.Config) *BattleAnimationManager {
...
func (am *BattleAnimationManager) GetCurrentAnimationResult() game.AnimationResultViewModel {
	if am.currentAnimation == nil {
		return game.AnimationResultViewModel{}
	}
	return game.AnimationResultViewModel{
		ActingEntry:    am.currentAnimation.Result.ActingEntry,
		TargetEntry:    am.currentAnimation.Result.TargetEntry,
		OriginalDamage: am.currentAnimation.Result.OriginalDamage,
		StartTime:      am.currentAnimation.StartTime,
	}
}

// GetCurrentActionResult は元々のActionResultを返します。
func (am *BattleAnimationManager) GetCurrentActionResult() *ActionResult {
	if am.currentAnimation == nil {
		return nil
	}
