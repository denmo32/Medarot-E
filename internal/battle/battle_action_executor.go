...
type ActionExecutor struct {
	...
	handlers               map[game.Trait]TraitActionHandler
	weaponHandlers         map[game.WeaponType]WeaponTypeEffectHandler // WeaponTypeごとのハンドラを追加

}

// NewActionExecutor は新しいActionExecutorのインスタンスを生成します。
func NewActionExecutor(world donburi.World, battleLogic *BattleLogic, gameConfig *game.Config) *ActionExecutor {
	...
	return &ActionExecutor{
		...
		handlers: map[game.Trait]TraitActionHandler{
			game.TraitShoot:    &BaseAttackHandler{},
			game.TraitAim:      &BaseAttackHandler{},
			game.TraitStrike:   &BaseAttackHandler{},
			game.TraitBerserk:  &BaseAttackHandler{},
			game.TraitSupport:  &SupportTraitExecutor{},
			game.TraitObstruct: &ObstructTraitExecutor{},
		},
		weaponHandlers: map[game.WeaponType]WeaponTypeEffectHandler{
