...
type WeaponTypeEffectHandler interface {
	ApplyEffect(result *ActionResult, world donburi.World, battleLogic *BattleLogic, actingPartDef *game.PartDefinition)
}
...
func (h *ThunderEffectHandler) ApplyEffect(result *ActionResult, world donburi.World, battleLogic *BattleLogic, actingPartDef *game.PartDefinition) {
...
func (h *MeltEffectHandler) ApplyEffect(result *ActionResult, world donburi.World, battleLogic *BattleLogic, actingPartDef *game.PartDefinition) {
	if result.ActionDidHit && result.TargetEntry != nil {
...
func (h *VirusEffectHandler) ApplyEffect(result *ActionResult, world donburi.World, battleLogic *BattleLogic, actingPartDef *game.PartDefinition) {
	if result.ActionDidHit && result.TargetEntry != nil {
