...
type UIActionModalManager struct {
	...
	actionTargetMap      map[core.PartSlotKey]component.ActionTarget // 選択可能なアクションとターゲットのマップ
...
func (m *UIActionModalManager) ShowActionModal(vm ui.ActionModalViewModel) {
	...
	m.actionTargetMap = make(map[core.PartSlotKey]component.ActionTarget)
...
func (m *UIActionModalManager) HideActionModal() {
	...
	m.actionTargetMap = make(map[core.PartSlotKey]component.ActionTarget) // ターゲットマップをクリア
...
func (m *UIActionModalManager) GetActionTargetMap() map[core.PartSlotKey]component.ActionTarget {
