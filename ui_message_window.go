...
func createMessageWindow(message string, messageManager *MessageManager, config *Config, font text.Face, uiFactory *UIFactory) widget.PreferredSizeLocateableWidget {
	c := config.UI
	...
	}, uiFactory, messageTextWidget, continueTextWidget) // uiFactoryを渡す
